"""
Copying the keras demo https://keras.io/examples/vision/conv_lstm/
Only changes are for saving the output, and increasing the training epochs
...
"""
from realsense_prediction.datatools import get_base_path
...
with (get_base_path() / 'keras_demo_exactly.np').open('wb') as f:
    np.save(f, track)
